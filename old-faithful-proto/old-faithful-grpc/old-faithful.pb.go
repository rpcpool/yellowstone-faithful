...
const (
	GetResponseErrorCode_GET_RESPONSE_INTERNAL  GetResponseErrorCode = 0
	GetResponseErrorCode_GET_RESPONSE_NOT_FOUND GetResponseErrorCode = 1
)

// Enum value maps for GetResponseErrorCode.
var (
	GetResponseErrorCode_name = map[int32]string{
		0: "GET_RESPONSE_INTERNAL",
		1: "GET_RESPONSE_NOT_FOUND",
	}
	GetResponseErrorCode_value = map[string]int32{
		"GET_RESPONSE_INTERNAL":  0,
		"GET_RESPONSE_NOT_FOUND": 1,
	}
)
...
type StreamBlocksErrorCode int32

const (
	StreamBlocksErrorCode_STREAM_BLOCKS_INTERNAL           StreamBlocksErrorCode = 0
	StreamBlocksErrorCode_STREAM_BLOCKS_INVALID_SLOT_RANGE StreamBlocksErrorCode = 1
	StreamBlocksErrorCode_STREAM_BLOCKS_SLOT_NOT_FOUND     StreamBlocksErrorCode = 2
)

// Enum value maps for StreamBlocksErrorCode.
var (
	StreamBlocksErrorCode_name = map[int32]string{
		0: "STREAM_BLOCKS_INTERNAL",
		1: "STREAM_BLOCKS_INVALID_SLOT_RANGE",
		2: "STREAM_BLOCKS_SLOT_NOT_FOUND",
	}
	StreamBlocksErrorCode_value = map[string]int32{
...
func (x StreamBlocksErrorCode) Enum() *StreamBlocksErrorCode {
	p := new(StreamBlocksErrorCode)
	*p = x
	return p
}

func (x StreamBlocksErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StreamBlocksErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_old_faithful_proto_enumTypes[1].Descriptor()
}

func (StreamBlocksErrorCode) Type() protoreflect.EnumType {
	return &file_old_faithful_proto_enumTypes[1]
}

func (x StreamBlocksErrorCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StreamBlocksErrorCode.Descriptor instead.
func (StreamBlocksErrorCode) EnumDescriptor() ([]byte, []int) {
...
func (x *GetResponseError) GetCode() GetResponseErrorCode {
	...
	return GetResponseErrorCode_GET_RESPONSE_INTERNAL
}
...
type StreamBlocksRequest struct {
	...
	EndSlot   *uint64             `protobuf:"varint,2,opt,name=end_slot,json=endSlot,proto3,oneof" json:"end_slot,omitempty"` // If not specified, continues indefinitely
...
type StreamBlocksResponse struct {
	...
	// Types that are assignable to Response:
	//
	//	*StreamBlocksResponse_Error
	//	*StreamBlocksResponse_Block
	Response isStreamBlocksResponse_Response `protobuf_oneof:"response"`
}
...
func (m *StreamBlocksResponse) GetResponse() isStreamBlocksResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *StreamBlocksResponse) GetError() *StreamBlocksError {
	if x, ok := x.GetResponse().(*StreamBlocksResponse_Error); ok {
		return x.Error
	}
	return nil
}

func (x *StreamBlocksResponse) GetBlock() *BlockResponse {
	if x, ok := x.GetResponse().(*StreamBlocksResponse_Block); ok {
		return x.Block
	}
	return nil
}

type isStreamBlocksResponse_Response interface {
	isStreamBlocksResponse_Response()
}

type StreamBlocksResponse_Error struct {
	Error *StreamBlocksError `protobuf:"bytes,1,opt,name=error,proto3,oneof"`
}

type StreamBlocksResponse_Block struct {
	Block *BlockResponse `protobuf:"bytes,2,opt,name=block,proto3,oneof"`
}

func (*StreamBlocksResponse_Error) isStreamBlocksResponse_Response() {}

func (*StreamBlocksResponse_Block) isStreamBlocksResponse_Response() {}

type StreamBlocksError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Code    StreamBlocksErrorCode `protobuf:"varint,1,opt,name=code,proto3,enum=OldFaithful.StreamBlocksErrorCode" json:"code,omitempty"`
	Message string                `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
}

func (x *StreamBlocksError) Reset() {
	*x = StreamBlocksError{}
...
func (x *StreamBlocksError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamBlocksError) ProtoMessage() {}

func (x *StreamBlocksError) ProtoReflect() protoreflect.Message {
	mi := &file_old_faithful_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamBlocksError.ProtoReflect.Descriptor instead.
func (*StreamBlocksError) Descriptor() ([]byte, []int) {
	return file_old_faithful_proto_rawDescGZIP(), []int{15}
}

func (x *StreamBlocksError) GetCode() StreamBlocksErrorCode {
	if x != nil {
		return x.Code
	}
...
func (x *StreamBlocksError) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_old_faithful_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x22, 0x8e, 0x01, 0x0a, 0x14,
	...
	,
	...
	,
	...
	0x77, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x2d, 0x66, 0x61, 0x69, 0x74, 0x68, 0x66, 0x75, 0x6c, 0x2f,
	0x6f, 0x6c, 0x64, 0x2d, 0x66, 0x61, 0x69, 0x74, 0x68, 0x66, 0x75, 0x6c, 0x2d, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x3b, 0x6f, 0x6c, 0x64, 0x5f, 0x66, 0x61, 0x69, 0x74, 0x68, 0x66, 0x75, 0x6c, 0x5f,
...
var file_old_faithful_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_old_faithful_proto_goTypes = []any{
	...
	(StreamBlocksErrorCode)(0),   // 1: OldFaithful.StreamBlocksErrorCode
	(*VersionRequest)(nil),       // 2: OldFaithful.VersionRequest
	(*VersionResponse)(nil),      // 3: OldFaithful.VersionResponse
	(*BlockRequest)(nil),         // 4: OldFaithful.BlockRequest
	(*BlockResponse)(nil),        // 5: OldFaithful.BlockResponse
	(*BlockTimeRequest)(nil),     // 6: OldFaithful.BlockTimeRequest
	(*BlockTimeResponse)(nil),    // 7: OldFaithful.BlockTimeResponse
	(*TransactionRequest)(nil),   // 8: OldFaithful.TransactionRequest
	(*TransactionResponse)(nil),  // 9: OldFaithful.TransactionResponse
	(*Transaction)(nil),          // 10: OldFaithful.Transaction
	(*GetRequest)(nil),           // 11: OldFaithful.GetRequest
	(*GetResponse)(nil),          // 12: OldFaithful.GetResponse
	(*GetResponseError)(nil),     // 13: OldFaithful.GetResponseError
	(*StreamBlocksRequest)(nil),  // 14: OldFaithful.StreamBlocksRequest
	(*StreamBlocksFilter)(nil),   // 15: OldFaithful.StreamBlocksFilter
	(*StreamBlocksResponse)(nil), // 16: OldFaithful.StreamBlocksResponse
	(*StreamBlocksError)(nil),    // 17: OldFaithful.StreamBlocksError
}
var file_old_faithful_proto_depIdxs = []int32{
	10, // 0: OldFaithful.BlockResponse.transactions:type_name -> OldFaithful.Transaction
	10, // 1: OldFaithful.TransactionResponse.transaction:type_name -> OldFaithful.Transaction
	2,  // 2: OldFaithful.GetRequest.version:type_name -> OldFaithful.VersionRequest
	6,  // 3: OldFaithful.GetRequest.block_time:type_name -> OldFaithful.BlockTimeRequest
	4,  // 4: OldFaithful.GetRequest.block:type_name -> OldFaithful.BlockRequest
	8,  // 5: OldFaithful.GetRequest.transaction:type_name -> OldFaithful.TransactionRequest
	13, // 6: OldFaithful.GetResponse.error:type_name -> OldFaithful.GetResponseError
	3,  // 7: OldFaithful.GetResponse.version:type_name -> OldFaithful.VersionResponse
	7,  // 8: OldFaithful.GetResponse.block_time:type_name -> OldFaithful.BlockTimeResponse
	5,  // 9: OldFaithful.GetResponse.block:type_name -> OldFaithful.BlockResponse
	9,  // 10: OldFaithful.GetResponse.transaction:type_name -> OldFaithful.TransactionResponse
	0,  // 11: OldFaithful.GetResponseError.code:type_name -> OldFaithful.GetResponseErrorCode
	15, // 12: OldFaithful.StreamBlocksRequest.filter:type_name -> OldFaithful.StreamBlocksFilter
	17, // 13: OldFaithful.StreamBlocksResponse.error:type_name -> OldFaithful.StreamBlocksError
	5,  // 14: OldFaithful.StreamBlocksResponse.block:type_name -> OldFaithful.BlockResponse
	1,  // 15: OldFaithful.StreamBlocksError.code:type_name -> OldFaithful.StreamBlocksErrorCode
	2,  // 16: OldFaithful.OldFaithful.GetVersion:input_type -> OldFaithful.VersionRequest
	4,  // 17: OldFaithful.OldFaithful.GetBlock:input_type -> OldFaithful.BlockRequest
	6,  // 18: OldFaithful.OldFaithful.GetBlockTime:input_type -> OldFaithful.BlockTimeRequest
	8,  // 19: OldFaithful.OldFaithful.GetTransaction:input_type -> OldFaithful.TransactionRequest
	11, // 20: OldFaithful.OldFaithful.Get:input_type -> OldFaithful.GetRequest
	14, // 21: OldFaithful.OldFaithful.StreamBlocks:input_type -> OldFaithful.StreamBlocksRequest
	3,  // 22: OldFaithful.OldFaithful.GetVersion:output_type -> OldFaithful.VersionResponse
	5,  // 23: OldFaithful.OldFaithful.GetBlock:output_type -> OldFaithful.BlockResponse
	7,  // 24: OldFaithful.OldFaithful.GetBlockTime:output_type -> OldFaithful.BlockTimeResponse
	9,  // 25: OldFaithful.OldFaithful.GetTransaction:output_type -> OldFaithful.TransactionResponse
	12, // 26: OldFaithful.OldFaithful.Get:output_type -> OldFaithful.GetResponse
	16, // 27: OldFaithful.OldFaithful.StreamBlocks:output_type -> OldFaithful.StreamBlocksResponse
...
func file_old_faithful_proto_init() {
	...
	file_old_faithful_proto_msgTypes[14].OneofWrappers = []any{
		(*StreamBlocksResponse_Error)(nil),
		(*StreamBlocksResponse_Block)(nil),
	}
	type x struct{}
