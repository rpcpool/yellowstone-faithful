...
|-------|------------------|--------------|-------------------------|--------------|----------------|------------------|
| 812 | pending cargen | 0 | 0.0% | 0 | 0.0% | 0 |
| 811 | pending cargen | 0 | 0.0% | 0 | 0.0% | 0 |
...
| **Total** | 41,163 | 40,087 | 97.4% | 34,379 | 85.8% | 5,708 |

## Summary for All Epochs

- **Metadata Entries**: 41,163
- **Deals in CSV**: 40,087
- **Deals to Metadata Ratio**: 97.4%
- **Deals Active**: 34,379
- **Percent Active**: 85.8%
- **Pieces Not Found**: 5,708

## Epochs where metadata > deals (140 epochs)
...
## Epochs where deals > active deals (308 epochs)
