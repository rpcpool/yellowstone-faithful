...
func TestBuilder(t *testing.T) {
	...
	expected := concatBytes(
		...
		// padding
		[]byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 3

		// --- Bucket header 0
		// hash domain
		[]byte{0x00, 0x00, 0x00, 0x00}, // 4
		// num entries
		[]byte{0x02, 0x00, 0x00, 0x00}, // 5
		// hash len
		[]byte{0x03}, // 6
		// padding
		[]byte{0x00}, // 7
		...
		[]byte{0x00}, // 12
		// file offset
		[]byte{0x9e, 0x00, 0x00, 0x00, 0x00, 0x00}, // 13
		...
		// --- Bucket 2
		// hash
		[]byte{0x98, 0x3d, 0xbd}, // 21
		// value
		[]byte{0x01, 0x71, 0x12, 0x20, 0x1b, 0x79, 0x02, 0x6c, 0x3d, 0xdc, 0x74, 0x0c, 0x33, 0x71, 0xf0, 0x7a, 0x4b, 0x80, 0xb0, 0x43, 0x0c, 0x82, 0x0a, 0x88, 0x72, 0x13, 0xa6, 0x94, 0x72, 0xc9, 0xd1, 0x8a, 0x2d, 0xc7, 0x88, 0x13}, // 22
		// hash
		...
		// hash
		[]byte{0x92, 0xcd, 0xbb}, // 25
		// value
		[]byte{0x01, 0x71, 0x12, 0x20, 0x9c, 0xd0, 0x17, 0x9a, 0x19, 0x9c, 0xd9, 0x51, 0xa, 0xfb, 0x92, 0x96, 0xcf, 0xd2, 0x9f, 0x77, 0x8a, 0x0, 0x40, 0x32, 0x8b, 0xf8, 0xff, 0x6, 0x46, 0x21, 0xb9, 0x3c, 0x57, 0xa5, 0xdd, 0xf}, // 26
	)
	...
	assert.Equal(t, []Entry{
		...
		{
			Hash:  0xbbcd92,
			Value: [36]byte(testCids[1].Bytes()),
		},
	}, entries)
