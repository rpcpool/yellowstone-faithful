...
export interface EpochRepository {
   ...
   */
  findById(id: EpochId): Promise<Epoch | null>;
  ...
  /**
   * Find an epoch by its epoch number
   */
  findByEpochNumber(epochNumber: number): Promise<Epoch | null>;
   ...
   */
  getLatestEpoch(): Promise<Epoch | null>;
   ...
   * Delete an epoch
   */
  delete(id: EpochId): Promise<void>;
