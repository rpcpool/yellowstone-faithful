...
// https://raw.githubusercontent.com/anza-xyz/agave/master/storage-proto/proto/confirmed_block.proto
// Last updated:
// https://github.com/anza-xyz/agave/blob/v4.2.1/storage-proto/proto/confirmed_block.proto
...
type Message struct {
	...
	Config              *TransactionConfig           `protobuf:"bytes,7,opt,name=config,proto3" json:"config,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_confirmed_block_proto_rawDesc = "" +
	"\n" +
	"\x15confirmed_block.proto\x12\x1dsolana.storage.ConfirmedBlock\"\x89\x04\n" +
	...
	"signatures\x12@\n" +
	"\amessage\x18\x02 \x01(\v2&.solana.storage.ConfirmedBlock.MessageR\amessage\"\xcb\x03\n" +
	"\aMessage\x12D\n" +
	...
	"\x15address_table_lookups\x18\x06 \x03(\v28.solana.storage.ConfirmedBlock.MessageAddressTableLookupR\x13addressTableLookups\x12H\n" +
	"\x06config\x18\a \x01(\v20.solana.storage.ConfirmedBlock.TransactionConfigR\x06config\"\xcd\x01\n" +
	"\rMessageHeader\x126\n" +
	...
	"\x10readonly_indexes\x18\x03 \x01(\fR\x0freadonlyIndexes\"\xb5\x02\n" +
	...
	"\x10DeactivatedStake\x10\x05BRZPgithub.com/rpcpool/yellowstone-faithful/third_party/solana_proto;confirmed_blockb\x06proto3"

var (
	file_confirmed_block_proto_rawDescOnce sync.Once
	file_confirmed_block_proto_rawDescData []byte
)

func file_confirmed_block_proto_rawDescGZIP() []byte {
	file_confirmed_block_proto_rawDescOnce.Do(func() {
		file_confirmed_block_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_confirmed_block_proto_rawDesc), len(file_confirmed_block_proto_rawDesc)))
	})
...
var file_confirmed_block_proto_goTypes = []any{
	...
	(*TransactionConfig)(nil),         // 7: solana.storage.ConfirmedBlock.TransactionConfig
...
var file_confirmed_block_proto_depIdxs = []int32{
	...
	7,  // 11: solana.storage.ConfirmedBlock.Message.config:type_name -> solana.storage.ConfirmedBlock.TransactionConfig
...
func file_confirmed_block_proto_init() {
	...
	file_confirmed_block_proto_msgTypes[7].OneofWrappers = []any{}
	file_confirmed_block_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_confirmed_block_proto_rawDesc), len(file_confirmed_block_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   0,
